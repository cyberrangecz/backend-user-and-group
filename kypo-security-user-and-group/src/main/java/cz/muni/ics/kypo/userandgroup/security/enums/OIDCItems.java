...
public enum OIDCItems {
    ...
    SUB("sub", "Subject - Identifier for the End-User at the Issuer.", "999999@muni.cz"),
    ISS("iss", "Specifies the issuing authority.", "https://oidc.muni.cz/oidc/"),
    ...
    EMAIL("email", "End-User's preferred e-mail address.", "999999@mail.muni.cz"),
