...
public interface RoleFacade {
     ...
     */
    RoleDTO getById(Long id) throws UserAndGroupFacadeException;
     ...
     */
    RoleDTO getByRoleType(RoleTypeDTO roleType) throws UserAndGroupFacadeException;
     ...
     */
    PageResultResource<RoleDTO> getAllRoles(Pageable pageable) throws UserAndGroupFacadeException, MicroserviceException;
