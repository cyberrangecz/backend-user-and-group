...
import cz.muni.ics.kypo.userandgroup.dto.group.GroupViewDTO;
...
import cz.muni.ics.kypo.userandgroup.dto.user.UserUpdateDTO;
...
public class TestDataFactory {
    ...
    private final Microservice kypoTrainingMicroservice
            = new Microservice("training", "http://kypo-training/api/v1");
    private final Microservice kypoUaGMicroservice
            = new Microservice("userAndGroup", "http://kypo-user-and-group/api/v1");

    private final NewMicroserviceDTO newMicroserviceDTO
            = generateNewMicroserviceDTO("training", "http://kypo-training/api/v1");

    private final MicroserviceDTO microserviceTrainingDTO
            = generateMicroserviceDTO("training", "http://kypo-training/api/v1");
    private final MicroserviceDTO microserviceUserAndGroupDTO
            = generateMicroserviceDTO("userAndGroup", "http://kypo-user-and-group/api/v1");
