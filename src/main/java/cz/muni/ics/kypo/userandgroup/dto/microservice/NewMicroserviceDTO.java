package cz.muni.ics.kypo.userandgroup.dto.microservice;
...
public class NewMicroserviceDTO {
    ...
    @ApiModelProperty(value = "A name of the microservice.", required = true, example = "kypo-training")
    @NotEmpty(message = "{microservice.name.NotEmpty.message}")
    private String name;
    @ApiModelProperty(value = "URI of the microservice.", required = true, example = "/kypo-rest-training/api/v1")
