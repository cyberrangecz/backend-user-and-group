...
public interface RoleRepositoryCustom {
    ...
    /**
     * Find all roles, not in the given {@link cz.muni.ics.kypo.userandgroup.domain.IDMGroup} ID.
     *
     * @param groupId   unique identifier of the group whose roles will be omitted.
     * @param predicate represents a predicate (boolean-valued function) of one argument.
     * @param pageable  abstract interface for pagination information.
     * @return returns list of all {@link Role}s except those in {@link cz.muni.ics.kypo.userandgroup.domain.IDMGroup}
