...
public class MicroserviceDTO {
    ...
    private Long id;
    @ApiModelProperty(value = "A name of the microservice.", example = "kypo-training")
    private String name;
    @ApiModelProperty(value = "URI of the microservice.", example = "/kypo-rest-training/api/v1")
